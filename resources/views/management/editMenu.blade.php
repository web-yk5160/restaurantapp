...
<div class="container">
  <div class="row justify-content-center">
    ...
    <div class="col-md-8">
      <i class="fas fa-hamburger"></i> メニュー編集　
      <hr>
      @if($errors->any())
      ...
      <form action="/management/menu/{{$menu->id}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <input type="text" name="name" value="{{$menu->name}}" class="form-control" place-holder="メニュー">
        </div>
        ...
        <div class="form-group">
          ...
          <input type="text" name="description" class="form-control" placeholder="内容を入力" value="{{$menu->description}}">
        </div>
